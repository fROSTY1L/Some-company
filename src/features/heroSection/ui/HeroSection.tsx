  ...
  return (
    <Layout>
      <Layout.Content style={{ 
        ...
        >
          <Col xs={24} md={12}>
            <Typography.Title level={1} style={{ marginBottom: token.marginLG }}>
              Most important title on the page
            </Typography.Title>
            <Typography.Paragraph style={{ fontSize: token.fontSizeLG }}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
              Aliquam mattis, leo et condimentum ultricies, sem urna convallis 
              metus, vel suscipit nibh lacus tincidunt ante
